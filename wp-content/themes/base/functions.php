...
function base_scripts() {
	...
	wp_enqueue_script( 'sui-script', get_stylesheet_directory_uri() . '/Semantic-UI-CSS-2.4.0/semantic.min.js', array(
             'jquery' 
        ), false, true );
    wp_enqueue_style( 'sui-style', get_stylesheet_directory_uri() . '/Semantic-UI-CSS-2.4.0/semantic.min.css' );
